...
var data_atual = new Date(); // new Date(); guarda o valor da data atual em uma variável.

var dia_semana = data_atual.getDay(); //getDay retorna o dia da semana com valores de 0 a 6. Usamos o valor retornado para acessar um obj da coleção.
